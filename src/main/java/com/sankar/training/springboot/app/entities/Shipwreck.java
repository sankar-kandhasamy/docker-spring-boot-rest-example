package com.sankar.training.springboot.app.entities;
...
public class Shipwreck {
	...
	public Shipwreck(Long id, String name, String description, String conditions, Integer depth, Double latitude,
